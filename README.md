...
| [`stride-gemini-ideation`](https://github.com/cheezy/stride-gemini-ideation) | 0.4.1 | `gemini extensions install https://github.com/cheezy/stride-gemini-ideation` | Ideation commands, skill, and custom agents for Stride kanban — Gemini CLI edition. Turns a fuzzy idea into a committed requirements doc (/ideate) and seeds a Stride backlog from it (/stridify). |
